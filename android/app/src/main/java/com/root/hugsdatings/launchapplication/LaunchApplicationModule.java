package com.root.hugsdatings.launchapplication;
...
public class LaunchApplicationModule extends ReactContextBaseJavaModule {
  ...
  //  Intent dialogIntent = new Intent(getReactApplicationContext(), MainActivity.class);
    Intent dialogIntent = getReactApplicationContext().getPackageManager().getLaunchIntentForPackage("com.root.hugsdatings");
